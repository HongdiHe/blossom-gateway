...
/**
 * Dynamic service cache configuration management class.
 * Used for caching configurations pulled from the config center.
 */
public class DynamicConfigManager {
	...
	public void addServiceInstance(String uniqueId, ServiceInstance serviceInstance) {
		Set<ServiceInstance> set = serviceInstanceMap.computeIfAbsent(uniqueId, k -> ConcurrentHashMap.newKeySet());
