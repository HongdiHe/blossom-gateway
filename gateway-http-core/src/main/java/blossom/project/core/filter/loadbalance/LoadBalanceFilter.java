...
public class LoadBalanceFilter implements Filter {
    private static final Logger log = LoggerFactory.getLogger(LoadBalanceFilter.class);
    ...
    public void doFilter(GatewayContext ctx) {
        ...
        log.debug("Selected instance - IP: {}, Port: {}", serviceInstance.getIp(), serviceInstance.getPort());
